<html>
    ...
    <body>
        ...
        <h1>
            ...
            } while ((abs($casaX-$palomaX)<$tamañoMapa/2)||(abs($casaY-$palomaY)<$tamañoMapa/2)&&(abs($casaX-$gorrionX)<$tamañoMapa/2)||(abs($casaY-$gorrionY)<$tamañoMapa/2));
            ...
            do
            {
                ...
                elseif ($gorrionX>$casaX)
                    $gorrionX--;
               
               
                if ($gorrionY<$casaY)
                    $gorrionY++;
                elseif ($gorrionY>$casaY)
                    $gorrionY--;
            ...
            } while (($palomaX != $casaX || $palomaY != $casaY) && ($gorrionX != $casaY || $gorrionY != $casaY ));
