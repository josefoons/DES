        ...
        <h1>
            ...
            //-------------------------    
               ...
               if($horientacion2 == 0) {
                ...
                for ($y=0; $y<$tamañoMapa; $y++) {
                    for ($x=0; $x<$tamañoMapa; $x++) {
                       ...
                       if ($x == $pelotaX && $y == $pelotaY)  {
                        ...
                        } elseif($x == $inicioBarraX  && $y == $alturaBarra) {
                            echo '<span class="pelota">T</span>'; #barra
                        } elseif($x + 1 == $inicioBarraX  && $y == $alturaBarra) {
                            echo '<span class="pelota">T</span>'; #barra
                        } elseif($x + 2 == $finalBarraX  && $y == $alturaBarra) {
                            echo '<span class="pelota">T</span>'; #barra
                        } else {
                ...
                Ax=$pelotaX Ay=$pelotaY
                Bx=$pelotaX1 By=$pelotaY1
                Cx=$pelotaX2 Cy=$pelotaY2  Rebotes=$rebotes</div></div>\n";
